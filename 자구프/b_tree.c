...
////50 25 76 38 19 58 29 88 44 22 11 34 17 52 26 61 55 51
//
//int main() {
//	int key;
//	int choice;
...
//		int i;
//		if (ptr->p[0] == 0) {
//			printf("[%d] : n = %d,(%d)", ptr, ptr->n, -1);
//		}
//		else
//			printf("[%d] : n = %d,(%d)",ptr,ptr->n,ptr->p[0]);
//		for (i = 0; i < ptr->n; i++)
//		{
//			if (ptr->p[i + 1] == 0) {
//				printf("(%d,%d) ", ptr->keys[i], -1);
//			}
//			else
//				printf("(%d,%d) ", ptr->keys[i],ptr->p[i+1]);
//		}
//		printf("\n");
//		for (i = 0; i <= ptr->n; i++)
